...
class FeeCalculatorTest {
    ...
    // On pourrait faire un BeforeEach pour créer un visiteur et set son age au début de chaque test
    @Test
    ...
    public void should_throw_exception_when_ticketType_not_supported_for_age_above_14()
    {
        ...
        //THEN
        assertThat(erreur).isNotNull().isInstanceOf(IllegalArgumentException.class).hasMessage("TicketType not supported");
    }

    @Test
    public void should_throw_exception_when_ticketType_not_supported_for_age_below_14()
    {
        //GIVEN
        Visitor child = new Visitor(10);
